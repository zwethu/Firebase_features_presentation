...
const TRACKED_EVENTS: { name: string; description: string }[] = [
  ...
  { name: 'quiz_cta_clicked', description: 'Fired when the A/B preview CTA is clicked (/ab-testing) — variant A|B only' },
  { name: 'demo_controlled_error_triggered', description: 'Fired after confirming the controlled error (/error-monitoring)' },

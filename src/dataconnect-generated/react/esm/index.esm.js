import { createUserRef, updateUserBioRef, deleteUserRef, getCurrentUserRef, listAllUsersRef, createProjectRef, updateProjectRef, deleteProjectRef, getProjectRef, listMyProjectsRef, createTaskRef, updateTaskStatusRef, deleteTaskRef, getTaskRef, listProjectTasksRef, addProjectMemberRef, updateMemberRoleRef, removeProjectMemberRef, getMembersRef, listMyMembershipsRef, addCommentRef, deleteCommentRef, getTaskCommentsRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useAddProjectMember(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
...
export function useRemoveProjectMember(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
...
export function useGetMembers(dcOrVars, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts } = validateReactArgs(connectorConfig, dcOrVars, varsOrOptions, options, true, true);
...
export function useGetTaskComments(dcOrVars, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts } = validateReactArgs(connectorConfig, dcOrVars, varsOrOptions, options, true, true);

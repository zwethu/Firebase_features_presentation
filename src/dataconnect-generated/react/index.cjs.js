const { createUserRef, updateUserBioRef, deleteUserRef, getCurrentUserRef, listAllUsersRef, createProjectRef, updateProjectRef, deleteProjectRef, getProjectRef, listMyProjectsRef, createTaskRef, updateTaskStatusRef, deleteTaskRef, getTaskRef, listProjectTasksRef, addProjectMemberRef, updateMemberRoleRef, removeProjectMemberRef, getMembersRef, listMyMembershipsRef, addCommentRef, deleteCommentRef, getTaskCommentsRef, connectorConfig } = require('../index.cjs.js');
...
exports.useAddProjectMember = function useAddProjectMember(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
    return addProjectMemberRef(dcInstance, vars);
  }
  return useDataConnectMutation(refFactory, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}
...
exports.useRemoveProjectMember = function useRemoveProjectMember(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
    return removeProjectMemberRef(dcInstance, vars);
  }
  return useDataConnectMutation(refFactory, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}


exports.useGetMembers = function useGetMembers(dcOrVars, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts } = validateReactArgs(connectorConfig, dcOrVars, varsOrOptions, options, true, true);
  const ref = getMembersRef(dcInstance, inputVars);
  return useDataConnectQuery(ref, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}
...
exports.useGetTaskComments = function useGetTaskComments(dcOrVars, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts } = validateReactArgs(connectorConfig, dcOrVars, varsOrOptions, options, true, true);
  const ref = getTaskCommentsRef(dcInstance, inputVars);
  return useDataConnectQuery(ref, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}